...
import 'package:wayos_clone/features/home/application/pages/report/material_create_page.dart';
import 'package:wayos_clone/features/home/application/pages/report/report_page.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case ATTENDANCE_JUSTIFICATION_ROUTE:
      return MaterialPageRoute(
        builder: (context) => const AttendanceJustificationPage(),
        settings: settings,
      );
